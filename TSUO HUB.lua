if game:GetService("CoreGui"):FindFirstChild("TSUO GUI") then
	game:GetService("CoreGui"):FindFirstChild("TSUO GUI"):Destroy()
end
local DiscordLib = {}
...
local serv = win:Server("TSUO HUB","")
...
Setting:Button("Copy Link Discord : TSUO HUB", function()
